...
if (isset($_SESSION['autorExist']) && $_SESSION['autorExist'] == true && isset($_SESSION['loger']) && $_SESSION['loger'] == true && $_SESSION['username']=='user') {
  ...
  <div class="container">
    <div class="header-inner">
      <div class="col-sm-4 col-xs-6 header-left">
        <div> <a href="home2.php"><img src="image/logo1.jpg" title="logo-vega" alt="logo-vega" class="img-responsive" /></a> </div>
         
      </div>
      <div class="col-sm-4 col-xs-12 header-middle">
        <div class="header-middle-top">
          <div id="logo"> <a href="home2.php"><img src="image/logo.png" title="E-Commerce" alt="E-Commerce" class="img-responsive" /></a> </div>
        </div>
      </div>
...
<script src="javascript/postListUser.js" type="text/javascript"></script>
