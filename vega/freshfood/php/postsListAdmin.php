        ...
        <h2>Posts</h2><hr>
            <div class="blog1 blog">
                ...
                if(mysqli_num_rows($result)>0 ){
                    ...
                    echo '<H1>'.$row['titulo'].' <span style="float:right !important" class="glyphicon glyphicon-wrench">
                          <ul class="glyphicon glyphicon-trash" onclick="borrarPost('.$row['id'].')"></ul></span></H1><br>';
